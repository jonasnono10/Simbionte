...
| arquivo | escopo |
|---|---|
| `cockpit-simbionte.architecture.json` | Cockpit V0 — composição somente leitura sobre Radar, tarefas, Inbox, IA e atividades; falhas isoladas e links de volta aos contextos do core |
