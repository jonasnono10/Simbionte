...
export const DICIONARIO: Traducoes = {
  ...
  // Cockpit SIMBIONTE — a primeira composição somente leitura da operação.
  "Cockpit": { es: "Panel de control" },
  "O que pede atenção agora: atendimento, prioridades, IA e atividade recente.": {
    es: "Lo que requiere atención ahora: servicio, prioridades, IA y actividad reciente.",
  },
  "O que pede atenção agora, reunido sem alterar a operação.": {
    es: "Lo que requiere atención ahora, reunido sin modificar la operación.",
  },
  "Resumo da operação": { es: "Resumen de la operación" },
  "Na fila humana": { es: "En la cola humana" },
  "Conversas que pedem uma pessoa agora": { es: "Conversaciones que necesitan una persona ahora" },
  "Riscos críticos": { es: "Riesgos críticos" },
  "Classificação do Radar de Risco": { es: "Clasificación del Radar de Riesgo" },
  "Tarefas atrasadas": { es: "Tareas atrasadas" },
  "Tarefas abertas com prazo vencido": { es: "Tareas abiertas con el plazo vencido" },
  "Avisos da IA": { es: "Avisos de la IA" },
  "Avisos abertos na Central da IA": { es: "Avisos abiertos en la Central de IA" },
  "Fonte indisponível agora": { es: "Fuente no disponible ahora" },
  "Prioridades": { es: "Prioridades" },
  "Fatos, inferências e recomendações aparecem separados para você decidir.": {
    es: "Los hechos, las inferencias y las recomendaciones aparecen por separado para que decidas.",
  },
  "Parte das prioridades não pôde ser carregada. O restante continua disponível.": {
    es: "No se pudo cargar una parte de las prioridades. El resto sigue disponible.",
  },
  "As fontes de prioridades estão indisponíveis agora. Tente novamente em instantes.": {
    es: "Las fuentes de prioridades no están disponibles ahora. Inténtalo de nuevo en unos instantes.",
  },
  "Nenhuma prioridade crítica foi encontrada agora.": {
    es: "No se encontró ninguna prioridad crítica ahora.",
  },
  "Estado atual das conversas abertas.": { es: "Estado actual de las conversaciones abiertas." },
  "Não foi possível ler os indicadores do Inbox agora.": {
    es: "No se pudieron leer los indicadores de la bandeja de entrada ahora.",
  },
  "Com a IA": { es: "Con la IA" },
  "Conversas abertas": { es: "Conversaciones abiertas" },
  "Abrir Inbox": { es: "Abrir bandeja de entrada" },
  "Configuração e sinais das últimas 24 horas.": {
    es: "Configuración y señales de las últimas 24 horas.",
  },
  "Não foi possível ler o estado da IA agora.": { es: "No se pudo leer el estado de la IA ahora." },
  "Nenhum agente de IA foi configurado nesta organização.": {
    es: "No se configuró ningún agente de IA en esta organización.",
  },
  "Configurar agentes": { es: "Configurar agentes" },
  "Agentes no ar": { es: "Agentes en funcionamiento" },
  "Publicados": { es: "Publicados" },
  "Execuções em 24 h": { es: "Ejecuciones en 24 h" },
  "Falhas em 24 h": { es: "Fallos en 24 h" },
  "Ver execuções da IA": { es: "Ver ejecuciones de la IA" },
  "Atividade recente": { es: "Actividad reciente" },
  "Últimos movimentos registrados no CRM.": { es: "Últimos movimientos registrados en el CRM." },
  "Não foi possível ler a atividade recente agora.": {
    es: "No se pudo leer la actividad reciente ahora.",
  },
  "Ainda não há atividade registrada.": { es: "Todavía no hay actividad registrada." },
  "Abrir": { es: "Abrir" },
  "Ver relatório de atividades": { es: "Ver informe de actividades" },
  "Aprovações": { es: "Aprobaciones" },
  "Decisões que exigem confirmação humana aparecerão aqui.": {
    es: "Las decisiones que requieren confirmación humana aparecerán aquí.",
  },
  "Supervisor": { es: "Supervisor" },
  "A conversa com o Supervisor ainda não está ativa neste Cockpit.": {
    es: "La conversación con el Supervisor aún no está activa en este panel.",
  },
  "Disponível em próxima etapa": { es: "Disponible en una próxima etapa" },
  "Crítica": { es: "Crítica" },
  "Fato": { es: "Hecho" },
  "Inferência": { es: "Inferencia" },
  "Recomendação": { es: "Recomendación" },
  "Risco crítico": { es: "Riesgo crítico" },
  "Retomar contato": { es: "Retomar el contacto" },
  "Definir o próximo passo": { es: "Definir el próximo paso" },
  "Concluir ou reagendar": { es: "Completar o reprogramar" },
  "Abrir contexto": { es: "Abrir contexto" },
  "Prazo vencido em": { es: "Plazo vencido el" },
  "Sem atividade há": { es: "Sin actividad desde hace" },
  "Aberta há": { es: "Abierta hace" },
  "Em risco": { es: "En riesgo" },
  "sem próximo passo registrado": { es: "sin próximo paso registrado" },
  "Demanda aberta": { es: "Demanda abierta" },
};
